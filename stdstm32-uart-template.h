...
void UART$_IRQHandler(void)
{
  ...
  LL_USART_WriteReg(UART$_UARTx, ICR, (USART_ICR_ORECF | USART_ICR_NCF | USART_ICR_FECF | USART_ICR_PECF | USART_ICR_IDLECF));
#elif defined STM32F7
...
#if !(defined UART$_USE_LPUART1 || defined UART$_USE_LPUART1_REMAPPED) // for the moment, don't allow it for LPUART
...
LL_LPUART_InitTypeDef LPUART_InitStruct = {0};
  LPUART_InitStruct.BaudRate = UART$_BAUD;
  ...
  LL_LPUART_Init(UART$_UARTx, &LPUART_InitStruct);
