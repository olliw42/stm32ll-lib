...
// Interface:
//
// #define UART$_USE_UART1, UART$_USE_UART1_PA9PA10, UART$_USE_UART1_PB6PB7, UART$_USE_UART1_PC4PC5, UART$_USE_UART1_PB14PB15
// #define UART$_USE_UART2, UART$_USE_UART2_PA2PA3, UART$_USE_UART2_PD5PD6, UART$_USE_UART2_PB3PB4, UART$_USE_UART2_PA14PA15, UART$_USE_UART2_PA5PA15
// #define UART$_USE_UART3, UART$_USE_UART3_PB10PB11, UART$_USE_UART3_PC10PC11, UART$_USE_UART3_PB8PB9, UART$_USE_UART3_PA4PA3, UART$_USE_UART3_PB3PB8
// #define UART$_USE_UART4, UART$_USE_UART4_PC10PC11, UART$_USE_UART4_PA0PA1
// #define UART$_USE_UART5, UART$_USE_UART5_PC12PD2
// #define UART$_USE_UART6, UART$_USE_UART6_PC6PC7, UART$_USE_UART6_PG14PG9
// #define UART$_USE_UART7, UART$_USE_UART7_PE8PE7, UART$_USE_UART7_PF7PF6, UART$_USE_UART7_PB4PB3, UART$_USE_UART7_PA15PA8
// #define UART$_USE_UART8, UART$_USE_UART8_PE1PE0
// #define UART$_USE_LPUART1, UART$_USE_LPUART1_PA2PA3, UART$_USE_LPUART1_PC1PC0, UART$_USE_LPUART1_PA9PA10, UART$_USE_LPUART1_PB6PB7
//
// #define UART$_BAUD
//
// #define UART$_USE_TX
...
// see stdstm32-peripherals.h
      ...
      defined UART$_USE_UART1_PB14PB15
  ...
  #elif defined UART$_USE_UART1_PB14PB15 // only H5
    #define UART$_TX_IO           IO_PB14
    #define UART$_RX_IO           IO_PB15
  #endif
  #ifndef STM32F0
  ...
  #define UART$_IRQHandler        USART1_IRQHandler
    ...
    // H5: PA9/PA10 and PB6/PB7 are AF7 as set above, PB14/PB15 are AF4, on both lines
    #if defined UART$_USE_UART1_PB14PB15
      #undef UART$_IO_AF
      #define UART$_IO_AF         IO_AF_4
    #elif defined UART$_USE_UART1_PC4PC5
      #error UART$_USE_UART1_PC4PC5 not available on STM32H5 !
    #endif
  #endif
      ...
      defined UART$_USE_UART2_PA5PA15
  #define UART$_UARTx             USART2
    ...
    #define UART$_TX_IO           IO_PB3
    #define UART$_RX_IO           IO_PA15
  #elif defined UART$_USE_UART2_PA5PA15 // only H5, the AN2606 bootloader pair
    #define UART$_TX_IO           IO_PA5
    #define UART$_RX_IO           IO_PA15
  #endif
  #ifndef STM32F0
    #define UART$_IO_AF           IO_AF_7
  ...
  #define UART$_IRQHandler        USART2_IRQHandler
    ...
    // H5: PA2/PA3 is AF7 as set above on both lines, everything else differs
      ...
      // H56x has USART2 only on PA2/PA3 and PD5/PD6, and PD5/PD6 is not bonded
        ...
        #error UART$_USE_UART2_PD5PD6 not bonded on STM32H56x packages up to LQFP64 ! use UART$_USE_UART2_PA2PA3
      #elif defined UART$_USE_UART2_PA5PA15 || defined UART$_USE_UART2_PB3PB4 || \
            defined UART$_USE_UART2_PA14PA15 || defined UART$_USE_UART2_PB3PA15
        #error UART$_USE_UART2 mapping not available on STM32H56x ! use UART$_USE_UART2_PA2PA3
      #endif
    #else
      // H503, the other mappings use different AFs
      #if defined UART$_USE_UART2_PB3PB4
        #undef UART$_IO_AF
        #define UART$_IO_AF       IO_AF_13
      #elif defined UART$_USE_UART2_PA14PA15
        #undef UART$_IO_AF
        #define UART$_IO_AF       IO_AF_9 // ATTENTION: PA14 overlaps with SWCLK
      #elif defined UART$_USE_UART2_PA5PA15
        #undef UART$_IO_AF
        #define UART$_IO_AF       IO_AF_9
      #elif defined UART$_USE_UART2_PD5PD6
        #error UART$_USE_UART2_PD5PD6 not available on STM32H503 !
      #elif defined UART$_USE_UART2_PB3PA15
        #error UART$_USE_UART2_PB3PA15 not available on STM32H503 !
      #endif
    #endif
  #endif
      ...
      defined UART$_USE_UART3_PA4PA3 || defined UART$_USE_UART3_PB3PB8
  ...
  #elif defined UART$_USE_UART3_PA4PA3 // only H5
    #define UART$_TX_IO           IO_PA4
    #define UART$_RX_IO           IO_PA3
  #elif defined UART$_USE_UART3_PB3PB8 // only H5
    #define UART$_TX_IO           IO_PB3
    #define UART$_RX_IO           IO_PB8
  #else
  #endif
  #ifndef STM32F0
    #define UART$_IO_AF           IO_AF_7
  ...
  #define UART$_IRQHandler        USART3_IRQHandler
    ...
    #define UART$_IRQHandler      USART3_4_IRQHandler
      ...
      #if defined UART$_USE_UART3_PB10PB11
        #error UART$_USE_UART3_PB10PB11 not bonded on STM32H56x packages up to LQFP64, PB11 is missing ! use UART$_USE_UART3_PC10PC11
      #elif defined UART$_USE_UART3_PB8PB9
        #error UART$_USE_UART3_PB8PB9 not bonded on STM32H56x packages up to LQFP64, PB9 is missing ! use UART$_USE_UART3_PC10PC11
      #elif defined UART$_USE_UART3_PA4PA3 || defined UART$_USE_UART3_PB3PB8
        #error UART$_USE_UART3 mapping not available on STM32H56x ! use UART$_USE_UART3_PC10PC11
      #endif
    #else
      ...
      #if defined UART$_USE_UART3_PA4PA3 || defined UART$_USE_UART3_PB3PB8
        #undef UART$_IO_AF
        #define UART$_IO_AF       IO_AF_13
      #elif defined UART$_USE_UART3_PB10PB11
        #error UART$_USE_UART3_PB10PB11 not available on STM32H503, PB11 does not exist ! use UART$_USE_UART3_PA4PA3 or UART$_USE_UART3_PB3PB8
      #elif defined UART$_USE_UART3_PB8PB9
        #error UART$_USE_UART3_PB8PB9 not available on STM32H503, PB9 does not exist ! use UART$_USE_UART3_PB3PB8
      #elif defined UART$_USE_UART3_PC10PC11
        #error UART$_USE_UART3_PC10PC11 not available on STM32H503 LQFP48, port C is not bonded !
      #endif
    #endif
  #endif
  ...
  #define UART$_UARTx             UART4
    ...
    #define UART$_TX_IO           IO_PC10
    #define UART$_RX_IO           IO_PC11
  #elif defined UART$_USE_UART4_PA0PA1 // only F7, H56x // was UART4_REMAPPED
...
#elif defined UART$_USE_UART6 || defined UART$_USE_UART6_PC6PC7 || defined UART$_USE_UART6_PG14PG9
  ...
  #define UART$_IRQHandler        USART6_IRQHandler
    ...
    // H56x USART6 is AF7, not AF8, and only PC6/PC7 is bonded up to LQFP64
    ...
    #elif defined UART$_USE_UART6_PG14PG9
      #error UART$_USE_UART6_PG14PG9 not bonded on STM32H56x packages up to LQFP64 ! use UART$_USE_UART6_PC6PC7
    #else
      #undef UART$_IO_AF
      #define UART$_IO_AF         IO_AF_7
    #endif
      ...
      defined UART$_USE_UART7_PB4PB3 || defined UART$_USE_UART7_PA15PA8
  ...
  #elif defined UART$_USE_UART7_PB4PB3 // only H56x
    #define UART$_TX_IO           IO_PB4
    #define UART$_RX_IO           IO_PB3
  #elif defined UART$_USE_UART7_PA15PA8 // only H56x // ATTENTION: PA15 is JTDI
    #define UART$_TX_IO           IO_PA15
    #define UART$_RX_IO           IO_PA8
  #endif
  #define UART$_IO_AF             IO_AF_8
  ...
  #define UART$_IRQHandler        UART7_IRQHandler
    ...
    #elif defined UART$_USE_UART7_PE8PE7 || defined UART$_USE_UART7_PF7PF6
      #error UART$_USE_UART7 mapping not bonded on STM32H56x packages up to LQFP64 ! use UART$_USE_UART7_PB4PB3 or UART$_USE_UART7_PA15PA8
    #else
      #undef UART$_IO_AF
      #define UART$_IO_AF         IO_AF_11
    #endif
  #endif
  ...
  #define UART$_IRQHandler        UART8_IRQHandler
    ...
    // H56x has UART8, but none of its pins is bonded up to LQFP64
      ...
      defined UART$_USE_LPUART1_PA9PA10 || defined UART$_USE_LPUART1_PB6PB7
  #define UART$_UARTx             LPUART1
    ...
    #define UART$_RX_IO           IO_PA3
      ...
      #undef UART$_TX_IO
      #undef UART$_RX_IO
      #define UART$_TX_IO         IO_PA3
      #define UART$_RX_IO         IO_PA2
      #define UART$_IO_AF         IO_AF_3
    #else
    ...
    #define UART$_IO_AF           IO_AF_8
  #elif defined UART$_USE_LPUART1_PA9PA10 // only H5, not swapped
    #define UART$_TX_IO           IO_PA9
    #define UART$_RX_IO           IO_PA10
    #define UART$_IO_AF           IO_AF_3
  #elif defined UART$_USE_LPUART1_PB6PB7 // only H5, not swapped
    #define UART$_TX_IO           IO_PB6
    #define UART$_RX_IO           IO_PB7
    #define UART$_IO_AF           IO_AF_8
  #endif
  #if defined UART$_USE_LPUART1_PA2PA3 && defined STM32H5_H56x
    // no pins were assigned above
    #error UART$_USE_LPUART1_PA2PA3 not available on STM32H56x ! use UART$_USE_LPUART1_PA9PA10 or UART$_USE_LPUART1_PB6PB7
  #endif
  ...
  #elif defined STM32WL
  #elif defined STM32H5
    #if defined UART$_USE_LPUART1_PC1PC0
      #if defined STM32H5_H56x
        // PC0/PC1 are bonded on LQFP64, but carry SAI2, not LPUART1
        #error UART$_USE_LPUART1_PC1PC0 not available on STM32H56x, PC0/PC1 are not LPUART1 pins ! use UART$_USE_LPUART1_PA9PA10 or UART$_USE_LPUART1_PB6PB7
      #else
        #error UART$_USE_LPUART1_PC1PC0 not available on STM32H503 LQFP48, port C is not bonded !
      #endif
    #endif
  #endif
...
void uart$_getbuf(uint8_t* buf, uint16_t len)
{
uint16_t i;

  for (i = 0; i < len; i++) buf[i] = uart$_getc();
}
...
// AN2606 Application note: STM32 microcontroller system memory boot mode
  ...
  #if defined UART$_USE_UART1_PA9PA10 || defined UART$_USE_UART2_PA5PA15 || defined UART$_USE_UART3_PA4PA3
    #define UART$_HAS_SYSTEMBOOT
  #endif
