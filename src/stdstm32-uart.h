...
#include "stdstm32-peripherals.h"
  ...
  #elif defined UART_USE_UART2_REMAPPED3 // only G4 // ATTENTION: PA14 overlaps with SWCLK
...
#elif defined STM32F3
  #warning UART F3 check clear flags, should be LL !?
  // ORE is enabled along with RXNE, but can be cleared by writing 1 to ICR
  LL_USART_WriteReg(UART_UARTx, ICR, (USART_ICR_ORECF | USART_ICR_NCF | USART_ICR_FECF | USART_ICR_PECF | USART_ICR_IDLECF));
#elif defined STM32F7
...
#if !(defined UART_USE_LPUART1 || defined UART_USE_LPUART1_REMAPPED) // for the moment, don't allow it for LPUART
...
LL_LPUART_InitTypeDef LPUART_InitStruct = {0};
  LPUART_InitStruct.BaudRate = UART_BAUD;
