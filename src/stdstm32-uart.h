...
#elif defined UART_USE_UART2 || defined UART_USE_UART2_REMAPPED || defined UART_USE_UART2_REMAPPED2
...
#elif defined UART_USE_UART3 || defined UART_USE_UART3_REMAPPED || defined UART_USE_UART3REMAPPED
...
void UART_IRQHandler(void)
{
  ...
  LL_USART_WriteReg(UART_UARTx, ICR, (LL_USART_ICR_ORECF|LL_USART_ICR_NCF|LL_USART_ICR_FECF|LL_USART_ICR_PECF|LL_USART_ICR_IDLECF));
#elif defined STM32F7
  ...
  LL_USART_WriteReg(UART_UARTx, ICR, (USART_ICR_IDLECF | USART_ICR_ORECF | USART_ICR_NECF | USART_ICR_FECF | USART_ICR_PECF));
#endif
#endif
...
void uart_tx_enable(FunctionalState flag)
{
#ifdef UART_USE_TX
  if (flag == ENABLE) {
...
#error Legacy UART_PRIORITY used !
  ...
  // Enable TX DMA
#if defined UART_USE_TX && defined UART_USE_TX_DMA
  rcc_init_dma(UART_DMA);

#if defined STM32F1 || defined STM32F7
  LL_USART_EnableDMAReq_TX(UART_UARTx);
#endif
#endif
  ...
  CLEAR_BIT(UART_UARTx->CR2, (USART_CR2_LINEN | USART_CR2_CLKEN));
  CLEAR_BIT(UART_UARTx->CR3, (USART_CR3_SCEN | USART_CR3_HDSEL | USART_CR3_IREN));
...
#endif
#endif
#if defined STM32G4 && !defined UART_USE_RXERRORCOUNT
#if !defined UART_USE_RXERRORCOUNT
