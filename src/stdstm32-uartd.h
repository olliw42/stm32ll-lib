...
#elif defined UARTD_USE_UART2 || defined UARTD_USE_UART2_REMAPPED || defined UARTD_USE_UART2_REMAPPED2
...
#elif defined UARTD_USE_UART3 || defined UARTD_USE_UART3_REMAPPED || defined UARTD_USE_UART3REMAPPED
...
void UARTD_IRQHandler(void)
{
  ...
  LL_USART_WriteReg(UARTD_UARTx, ICR, (LL_USART_ICR_ORECF|LL_USART_ICR_NCF|LL_USART_ICR_FECF|LL_USART_ICR_PECF|LL_USART_ICR_IDLECF));
#elif defined STM32F7
...
#elif defined STM32G4
  #warning UARTD G4 check clear flags, should be LL !?
  LL_USART_WriteReg(UARTD_UARTx, ICR, (USART_ICR_IDLECF | USART_ICR_ORECF | USART_ICR_NECF | USART_ICR_FECF | USART_ICR_PECF));
#endif
#endif
...
#error Legacy UARTD_PRIORITY used !
  ...
  // Enable TX DMA
#if defined UARTD_USE_TX && defined UARTD_USE_TX_DMA
  rcc_init_dma(UARTD_DMA);

#if defined STM32F1 || defined STM32F7
  LL_USART_EnableDMAReq_TX(UARTD_UARTx);
#endif
#endif
...
#endif
#endif
#if defined STM32G4 && !defined UARTD_USE_RXERRORCOUNT
#if !defined UARTD_USE_RXERRORCOUNT
