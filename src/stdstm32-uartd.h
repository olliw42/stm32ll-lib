...
#include "stdstm32-peripherals.h"
  ...
  #define UARTD_UARTx             USART2
  ...
  #elif defined UARTD_USE_UART2_REMAPPED3 // only G4, F0 // ATTENTION: on G4 PA14 overlaps with SWCLK
    ...
    #define UARTD_IO_AF           IO_AF_7
  #else
    #if defined UARTD_USE_UART2 || defined UARTD_USE_UART2_REMAPPED3
      #define UARTD_IO_AF         IO_AF_1
	#else  
  ...
  #define UARTD_UARTx             USART3
	...
	#elif defined UARTD_USE_UART3_REMAPPED
      #define UARTD_IO_AF         IO_AF_1
	#else  
