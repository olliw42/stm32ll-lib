...
#elif defined STM32F3
  #warning UARTD F3 check clear flags, should be LL !?
  // ORE is enabled along with RXNE, but can be cleared by writing 1 to ICR
  LL_USART_WriteReg(UARTD_UARTx, ICR, (USART_ICR_ORECF | USART_ICR_NCF | USART_ICR_FECF | USART_ICR_PECF | USART_ICR_IDLECF));
#elif defined STM32F7
...
#elif defined STM32L4
  #warning UARTD L4 check clear flags, should be LL !?
  LL_USART_WriteReg(UARTD_UARTx, ICR, (USART_ICR_IDLECF | USART_ICR_ORECF | USART_ICR_NECF | USART_ICR_FECF | USART_ICR_PECF));
#endif
#endif
...
#if !(defined UARTD_USE_LPUART1 || defined UARTD_USE_LPUART1_REMAPPED) // for the moment, don't allow it for LPUART
...
#if !(defined UARTD_USE_LPUART1 || defined UARTD_USE_LPUART1_REMAPPED)
LL_USART_InitTypeDef USART_InitStruct = {0};
