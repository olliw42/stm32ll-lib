...
// Interface:
//
// #define UARTF_USE_UART1, UARTF_USE_UART1_PA9PA10, UARTF_USE_UART1_PB6PB7, UARTF_USE_UART1_PC4PC5, UARTF_USE_UART1_PB14PB15
// #define UARTF_USE_UART2, UARTF_USE_UART2_PA2PA3, UARTF_USE_UART2_PD5PD6, UARTF_USE_UART2_PB3PB4, UARTF_USE_UART2_PA14PA15, UARTF_USE_UART2_PA5PA15
// #define UARTF_USE_UART3, UARTF_USE_UART3_PB10PB11, UARTF_USE_UART3_PC10PC11, UARTF_USE_UART3_PB8PB9, UARTF_USE_UART3_PA4PA3, UARTF_USE_UART3_PB3PB8
// #define UARTF_USE_UART4, UARTF_USE_UART4_PC10PC11, UARTF_USE_UART4_PA0PA1
// #define UARTF_USE_UART5, UARTF_USE_UART5_PC12PD2
// #define UARTF_USE_UART6, UARTF_USE_UART6_PC6PC7, UARTF_USE_UART6_PG14PG9
// #define UARTF_USE_UART7, UARTF_USE_UART7_PE8PE7, UARTF_USE_UART7_PF7PF6, UARTF_USE_UART7_PB4PB3, UARTF_USE_UART7_PA15PA8
// #define UARTF_USE_UART8, UARTF_USE_UART8_PE1PE0
// #define UARTF_USE_LPUART1, UARTF_USE_LPUART1_PA2PA3, UARTF_USE_LPUART1_PC1PC0, UARTF_USE_LPUART1_PA9PA10, UARTF_USE_LPUART1_PB6PB7
//
// #define UARTF_BAUD
//
// #define UARTF_USE_TX
...
#if defined UARTF_USE_UART1_REMAPPED || defined UARTF_USE_UART1_REMAPPED2
  #error REMAPPED not supported anymore!
#endif
#if defined UARTF_USE_UART2_REMAPPED || defined UARTF_USE_UART2_REMAPPED2 || defined UARTF_USE_UART2_REMAPPED3
  #error REMAPPED not supported anymore!
#endif
#if defined UARTF_USE_UART3_REMAPPED
  #error REMAPPED not supported anymore!
#endif
#if defined UARTF_USE_UART4_REMAPPED
  #error REMAPPED not supported anymore!
#endif
#if defined UARTF_USE_UART6_REMAPPED
  #error REMAPPED not supported anymore!
#endif
#if defined UARTF_USE_UART7_REMAPPED
  #error REMAPPED not supported anymore!
#endif
#if defined UARTF_USE_LPUART1_REMAPPED
  #error REMAPPED not supported anymore!
#endif
...
// see stdstm32-peripherals.h
...
#if defined UARTF_USE_UART1 || defined UARTF_USE_UART1_PA9PA10 || defined UARTF_USE_UART1_PB6PB7 || defined UARTF_USE_UART1_PC4PC5 || \
      defined UARTF_USE_UART1_PB14PB15
  #define UARTF_UARTx             USART1
  #ifdef UARTF_USE_UART1
    // user needs to specify UARTF_USE_TX_IO, UARTF_USE_RX_IO, and possibly UARTF_USE_IO_AF
  #elif defined UARTF_USE_UART1_PA9PA10
    #define UARTF_TX_IO           IO_PA9
    #define UARTF_RX_IO           IO_PA10
  #elif defined UARTF_USE_UART1_PB6PB7 // was UART1_REMAPPED
    #define UARTF_TX_IO           IO_PB6
    #define UARTF_RX_IO           IO_PB7
  #elif defined UARTF_USE_UART1_PC4PC5 // only G4 // was UART1_REMAPPED2
    #define UARTF_TX_IO           IO_PC4
    #define UARTF_RX_IO           IO_PC5
  #elif defined UARTF_USE_UART1_PB14PB15 // only H5
    #define UARTF_TX_IO           IO_PB14
    #define UARTF_RX_IO           IO_PB15
  #endif
  #ifndef STM32F0
    #define UARTF_IO_AF           IO_AF_7
  #else
    #ifdef UARTF_USE_UART1
      // user needs to specify UARTF_USE_IO_AF
    #elif defined UARTF_USE_UART1_PA9PA10
      #define UARTF_IO_AF         IO_AF_1
    #elif defined UARTF_USE_UART1_PB6PB7
      #define UARTF_IO_AF         IO_AF_0
    #else
      #error UARTF_USE_UART1 mapping not available on STM32F0 !
    #endif
  #endif
  ...
  #define UARTF_IRQHandler        USART1_IRQHandler
    ...
    #if defined UARTF_USE_UART1_PB14PB15
      #undef UARTF_IO_AF
      #define UARTF_IO_AF         IO_AF_4
    #elif defined UARTF_USE_UART1_PC4PC5
      #error UARTF_USE_UART1_PC4PC5 not available on STM32H5 !
    #endif
  #endif

#elif defined UARTF_USE_UART2 || defined UARTF_USE_UART2_PA2PA3 || defined UARTF_USE_UART2_PD5PD6 || \
      defined UARTF_USE_UART2_PB3PB4 || defined UARTF_USE_UART2_PA14PA15 || defined UARTF_USE_UART2_PB3PA15 || \
      defined UARTF_USE_UART2_PA5PA15
  #define UARTF_UARTx             USART2
  #ifdef UARTF_USE_UART2
    // user needs to specify UARTF_USE_TX_IO, UARTF_USE_RX_IO, and possibly UARTF_USE_IO_AF
  #elif defined UARTF_USE_UART2_PA2PA3
    #define UARTF_TX_IO           IO_PA2
    #define UARTF_RX_IO           IO_PA3
  #elif defined UARTF_USE_UART2_PD5PD6 // was UART2_REMAPPED
    #define UARTF_TX_IO           IO_PD5
    #define UARTF_RX_IO           IO_PD6
  #elif defined UARTF_USE_UART2_PB3PB4 // only G4 // was UART2_REMAPPED2
    #define UARTF_TX_IO           IO_PB3
    #define UARTF_RX_IO           IO_PB4
  #elif defined UARTF_USE_UART2_PA14PA15 // only G4, F0 // ATTENTION: on G4 PA14 overlaps with SWCLK // was UART2_REMAPPED3
    #define UARTF_TX_IO           IO_PA14
    #define UARTF_RX_IO           IO_PA15
  #elif defined UARTF_USE_UART2_PB3PA15 // only G4
    #define UARTF_TX_IO           IO_PB3
    #define UARTF_RX_IO           IO_PA15
  #elif defined UARTF_USE_UART2_PA5PA15 // only H5, the AN2606 bootloader pair
    #define UARTF_TX_IO           IO_PA5
    #define UARTF_RX_IO           IO_PA15
  #endif
  #ifndef STM32F0
    #define UARTF_IO_AF           IO_AF_7
  #else
    #if defined UARTF_USE_UART2
      // user needs to specify UARTF_USE_IO_AF
    #elif defined UARTF_USE_UART2_PA2PA3 || defined UARTF_USE_UART2_PA14PA15
      #define UARTF_IO_AF         IO_AF_1
    #else
      #error UARTF_USE_UART2 mapping not available on STM32F0 !
    #endif
  #endif
  ...
  #define UARTF_IRQHandler        USART2_IRQHandler
    ...
    // H5: PA2/PA3 is AF7 as set above on both lines, everything else differs
      ...
      #if defined UARTF_USE_UART2_PD5PD6
        #error UARTF_USE_UART2_PD5PD6 not bonded on STM32H56x packages up to LQFP64 ! use UARTF_USE_UART2_PA2PA3
      #elif defined UARTF_USE_UART2_PA5PA15 || defined UARTF_USE_UART2_PB3PB4 || \
            defined UARTF_USE_UART2_PA14PA15 || defined UARTF_USE_UART2_PB3PA15
        #error UARTF_USE_UART2 mapping not available on STM32H56x ! use UARTF_USE_UART2_PA2PA3
      #endif
    #else
      // H503, the other mappings use different AFs
      #if defined UARTF_USE_UART2_PB3PB4
        #undef UARTF_IO_AF
        #define UARTF_IO_AF       IO_AF_13
      #elif defined UARTF_USE_UART2_PA14PA15
        #undef UARTF_IO_AF
        #define UARTF_IO_AF       IO_AF_9 // ATTENTION: PA14 overlaps with SWCLK
      #elif defined UARTF_USE_UART2_PA5PA15
        #undef UARTF_IO_AF
        #define UARTF_IO_AF       IO_AF_9
      #elif defined UARTF_USE_UART2_PD5PD6
        #error UARTF_USE_UART2_PD5PD6 not available on STM32H503 !
      #elif defined UARTF_USE_UART2_PB3PA15
        #error UARTF_USE_UART2_PB3PA15 not available on STM32H503 !
      #endif
    #endif
  #endif

#elif defined UARTF_USE_UART3 || defined UARTF_USE_UART3_PB10PB11 || defined UARTF_USE_UART3_PC10PC11 || defined UARTF_USE_UART3_PB8PB9 || \
      defined UARTF_USE_UART3_PA4PA3 || defined UARTF_USE_UART3_PB3PB8
  #define UARTF_UARTx             USART3
  #if defined UARTF_USE_UART3
    // user needs to specify UARTF_USE_TX_IO, UARTF_USE_RX_IO, and possibly UARTF_USE_IO_AF
  #elif defined UARTF_USE_UART3_PB10PB11
    #define UARTF_TX_IO           IO_PB10
    #define UARTF_RX_IO           IO_PB11
  #elif defined UARTF_USE_UART3_PC10PC11 // was UART3_REMAPPED
    #define UARTF_TX_IO           IO_PC10
    #define UARTF_RX_IO           IO_PC11
  #elif defined UARTF_USE_UART3_PB8PB9 // only F3
    #define UARTF_TX_IO           IO_PB8
    #define UARTF_RX_IO           IO_PB9
  #elif defined UARTF_USE_UART3_PA4PA3 // only H5
    #define UARTF_TX_IO           IO_PA4
    #define UARTF_RX_IO           IO_PA3
  #elif defined UARTF_USE_UART3_PB3PB8 // only H5
    #define UARTF_TX_IO           IO_PB3
    #define UARTF_RX_IO           IO_PB8
  #else
  #endif
  #ifndef STM32F0
    #define UARTF_IO_AF           IO_AF_7
    ...
    #if defined UARTF_USE_UART3
      // user needs to specify UARTF_USE_IO_AF
    #elif defined defined UARTF_USE_UART3_PB10PB11 || defined UARTF_USE_UART3_PB8PB9
      #define UARTF_IO_AF         IO_AF_4
    #elif defined UARTF_USE_UART3_PC10PC11
      #define UARTF_IO_AF         IO_AF_1
    #else
      #error UARTF_USE_UART3 mapping not available on STM32F0 !
    #endif
  #endif
  ...
  #define UARTF_IRQHandler        USART3_IRQHandler
    ...
    #undef UARTF_IRQn
    #undef UARTF_IRQHandler
    #define UARTF_IRQn            USART3_4_IRQn
    #define UARTF_IRQHandler      USART3_4_IRQHandler
  #elif defined STM32H5
    #if defined STM32H5_H56x
      // H56x USART3 is AF7 as set above, and only PC10/PC11 is bonded up to LQFP64
      #if defined UARTF_USE_UART3_PB10PB11
        #error UARTF_USE_UART3_PB10PB11 not bonded on STM32H56x packages up to LQFP64, PB11 is missing ! use UARTF_USE_UART3_PC10PC11
      #elif defined UARTF_USE_UART3_PB8PB9
        #error UARTF_USE_UART3_PB8PB9 not bonded on STM32H56x packages up to LQFP64, PB9 is missing ! use UARTF_USE_UART3_PC10PC11
      #elif defined UARTF_USE_UART3_PA4PA3 || defined UARTF_USE_UART3_PB3PB8
        #error UARTF_USE_UART3 mapping not available on STM32H56x ! use UARTF_USE_UART3_PC10PC11
      #endif
    #else
      ...
      #if defined UARTF_USE_UART3_PA4PA3 || defined UARTF_USE_UART3_PB3PB8
        #undef UARTF_IO_AF
        #define UARTF_IO_AF       IO_AF_13
      #elif defined UARTF_USE_UART3_PB10PB11
        #error UARTF_USE_UART3_PB10PB11 not available on STM32H503, PB11 does not exist ! use UARTF_USE_UART3_PA4PA3 or UARTF_USE_UART3_PB3PB8
      #elif defined UARTF_USE_UART3_PB8PB9
        #error UARTF_USE_UART3_PB8PB9 not available on STM32H503, PB9 does not exist ! use UARTF_USE_UART3_PB3PB8
      #elif defined UARTF_USE_UART3_PC10PC11
        #error UARTF_USE_UART3_PC10PC11 not available on STM32H503 LQFP48, port C is not bonded !
      #endif
    #endif
  #endif

#elif defined UARTF_USE_UART4 || defined UARTF_USE_UART4_PC10PC11 || defined UARTF_USE_UART4_PA0PA1
  #define UARTF_UARTx             UART4
  #ifdef UARTF_USE_UART4
    // user needs to specify UARTF_USE_TX_IO, UARTF_USE_RX_IO, and possibly UARTF_USE_IO_AF
  #elif defined UARTF_USE_UART4_PC10PC11
    #define UARTF_TX_IO           IO_PC10
    #define UARTF_RX_IO           IO_PC11
  #elif defined UARTF_USE_UART4_PA0PA1 // only F7, H56x // was UART4_REMAPPED
    #define UARTF_TX_IO           IO_PA0
...
#elif defined UARTF_USE_UART5 || defined UARTF_USE_UART5_PC12PD2
  #define UARTF_UARTx             UART5
  #ifdef UARTF_USE_UART5
    // user needs to specify UARTF_USE_TX_IO, UARTF_USE_RX_IO, and possibly UARTF_USE_IO_AF
  #elif defined UARTF_USE_UART5_PC12PD2
...
#elif defined UARTF_USE_UART6 || defined UARTF_USE_UART6_PC6PC7 || defined UARTF_USE_UART6_PG14PG9
  #define UARTF_UARTx             USART6
  #ifdef UARTF_USE_UART6
    // user needs to specify UARTF_USE_TX_IO, UARTF_USE_RX_IO, and possibly UARTF_USE_IO_AF
  #elif defined UARTF_USE_UART6_PC6PC7
    #define UARTF_TX_IO           IO_PC6
    #define UARTF_RX_IO           IO_PC7
  #elif defined UARTF_USE_UART6_PG14PG9 // was UART6_REMAPPED
  ...
  #define UARTF_IRQHandler        USART6_IRQHandler
    ...
    #elif defined UARTF_USE_UART6_PG14PG9
      #error UARTF_USE_UART6_PG14PG9 not bonded on STM32H56x packages up to LQFP64 ! use UARTF_USE_UART6_PC6PC7
    #else
      #undef UARTF_IO_AF
      #define UARTF_IO_AF         IO_AF_7
    #endif
...
#elif defined UARTF_USE_UART7 || defined UARTF_USE_UART7_PE8PE7 || defined UARTF_USE_UART7_PF7PF6 || \
      defined UARTF_USE_UART7_PB4PB3 || defined UARTF_USE_UART7_PA15PA8
  #define UARTF_UARTx             UART7
  #ifdef UARTF_USE_UART7
    // user needs to specify UARTF_USE_TX_IO, UARTF_USE_RX_IO, and possibly UARTF_USE_IO_AF
  #elif defined UARTF_USE_UART7_PE8PE7
    #define UARTF_TX_IO           IO_PE8
    #define UARTF_RX_IO           IO_PE7
  #elif defined UARTF_USE_UART7_PF7PF6 // was UART7_REMAPPED
    #define UARTF_TX_IO           IO_PF7
    #define UARTF_RX_IO           IO_PF6
  #elif defined UARTF_USE_UART7_PB4PB3 // only H56x
    #define UARTF_TX_IO           IO_PB4
    #define UARTF_RX_IO           IO_PB3
  #elif defined UARTF_USE_UART7_PA15PA8 // only H56x // ATTENTION: PA15 is JTDI
    #define UARTF_TX_IO           IO_PA15
    #define UARTF_RX_IO           IO_PA8
  #endif
  #define UARTF_IO_AF             IO_AF_8
  ...
  #define UARTF_IRQHandler        UART7_IRQHandler
    ...
    #elif defined UARTF_USE_UART7_PE8PE7 || defined UARTF_USE_UART7_PF7PF6
      #error UARTF_USE_UART7 mapping not bonded on STM32H56x packages up to LQFP64 ! use UARTF_USE_UART7_PB4PB3 or UARTF_USE_UART7_PA15PA8
    #else
      #undef UARTF_IO_AF
      #define UARTF_IO_AF         IO_AF_11
    #endif
  #endif

#elif defined UARTF_USE_UART8 || defined UARTF_USE_UART8_PE1PE0
  #define UARTF_UARTx             UART8
  #ifdef UARTF_USE_UART8
    // user needs to specify UARTF_USE_TX_IO, UARTF_USE_RX_IO, and possibly UARTF_USE_IO_AF
  #elif defined UARTF_USE_UART8_PE1PE0
...
#elif defined UARTF_USE_LPUART1 || defined UARTF_USE_LPUART1_PA2PA3 || defined UARTF_USE_LPUART1_PC1PC0 || \
      defined UARTF_USE_LPUART1_PA9PA10 || defined UARTF_USE_LPUART1_PB6PB7
  #define UARTF_UARTx             LPUART1
  #ifdef UARTF_USE_LPUART1
    // user needs to specify UARTF_USE_TX_IO, UARTF_USE_RX_IO, and possibly UARTF_USE_IO_AF
  #elif defined UARTF_USE_LPUART1_PA2PA3
    #define UARTF_TX_IO           IO_PA2
    #define UARTF_RX_IO           IO_PA3
    #ifdef STM32G4
      ...
      #undef UARTF_TX_IO
      #undef UARTF_RX_IO
      #define UARTF_TX_IO         IO_PA3
      #define UARTF_RX_IO         IO_PA2
      #define UARTF_IO_AF         IO_AF_3
    #else
      #define UARTF_IO_AF         IO_AF_8 // WL
    #endif
  #elif defined UARTF_USE_LPUART1_PC1PC0 // was LPUART1_REMAPPED
    #define UARTF_TX_IO           IO_PC1
    #define UARTF_RX_IO           IO_PC0
    #define UARTF_IO_AF           IO_AF_8
  #elif defined UARTF_USE_LPUART1_PA9PA10 // only H5, not swapped
    #define UARTF_TX_IO           IO_PA9
    #define UARTF_RX_IO           IO_PA10
    #define UARTF_IO_AF           IO_AF_3
  #elif defined UARTF_USE_LPUART1_PB6PB7 // only H5, not swapped
    #define UARTF_TX_IO           IO_PB6
    #define UARTF_RX_IO           IO_PB7
    #define UARTF_IO_AF           IO_AF_8
  #endif
  #if defined UARTF_USE_LPUART1_PA2PA3 && defined STM32H5_H56x
    // no pins were assigned above
    #error UARTF_USE_LPUART1_PA2PA3 not available on STM32H56x ! use UARTF_USE_LPUART1_PA9PA10 or UARTF_USE_LPUART1_PB6PB7
  #endif
  ...
  #elif defined STM32WL
  #elif defined STM32H5
    #if defined UARTF_USE_LPUART1_PC1PC0
      #if defined STM32H5_H56x
        // PC0/PC1 are bonded on LQFP64, but carry SAI2, not LPUART1
        #error UARTF_USE_LPUART1_PC1PC0 not available on STM32H56x, PC0/PC1 are not LPUART1 pins ! use UARTF_USE_LPUART1_PA9PA10 or UARTF_USE_LPUART1_PB6PB7
      #else
        #error UARTF_USE_LPUART1_PC1PC0 not available on STM32H503 LQFP48, port C is not bonded !
      #endif
    #endif
  #endif
...
#if defined UARTF_USE_LPUART1 || defined UARTF_USE_LPUART1_PA2PA3 || defined UARTF_USE_LPUART1_PC1PC0 || \
    defined UARTF_USE_LPUART1_PA9PA10 || defined UARTF_USE_LPUART1_PB6PB7
  #define UARTF_IS_LPUART
#endif
...
#if defined UARTF_USE_TX && !defined UARTF_TX_IO
  #error No UARTF TX IO defined!
#endif
#if defined UARTF_USE_RX && !defined UARTF_RX_IO
  #error No UARTF RX IO defined!
#endif
#if !defined UARTF_IO_AF
  #error No UARTF IO AF defined!
#endif
...
void uartf_getbuf(uint8_t* buf, uint16_t len)
{
uint16_t i;

  for (i = 0; i < len; i++) buf[i] = uartf_getc();
}
...
#ifdef STM32F1
#if defined UARTF_USE_UART1_PB6PB7
  LL_GPIO_AF_EnableRemap_USART1();
#endif
#if defined UARTF_USE_UART2_PD5PD6
  LL_GPIO_AF_EnableRemap_USART2();
#endif
#if defined UARTF_USE_UART3_PC10PC11
...
#ifdef UARTF_USE_RX
#ifndef UARTF_INVERTED
  gpio_init_af(UARTF_RX_IO, IO_MODE_INPUT_PU, UARTF_IO_AF, IO_SPEED_VERYFAST);
#else
  gpio_init_af(UARTF_RX_IO, IO_MODE_INPUT_PD, UARTF_IO_AF, IO_SPEED_VERYFAST);
#endif
#endif
...
#ifdef UARTF_INVERTED
#ifdef UARTF_USE_TX
  LL_USART_SetTXPinLevel(UARTF_UARTx, LL_USART_TXPIN_LEVEL_INVERTED);
#endif
#ifdef UARTF_USE_RX
  LL_USART_SetRXPinLevel(UARTF_UARTx, LL_USART_RXPIN_LEVEL_INVERTED);
#endif
#endif
...
// AN2606 Application note: STM32 microcontroller system memory boot mode
  ...
  #if defined UARTF_USE_UART1_PA9PA10 || defined UARTF_USE_UART2_PA5PA15 || defined UARTF_USE_UART3_PA4PA3
    #define UARTF_HAS_SYSTEMBOOT
  #endif
