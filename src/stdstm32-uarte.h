...
// Interface:
//
// #define UARTE_USE_UART1 , UARTE_USE_UART2 , UARTE_USE_UART3 , UARTE_USE_UART3REMAPPED, UARTE_USE_UART4, UARTE_USE_UART5
// #define UARTE_BAUD
//
// #define UARTE_USE_TX
...
#if defined UARTE_USE_UART1 || defined UARTE_USE_UART1_REMAPPED
...
#elif defined UARTE_USE_UART2 || defined UARTE_USE_UART2_REMAPPED || defined UARTE_USE_UART2_REMAPPED2
...
#if defined UARTE_USE_UART3REMAPPED
...
#error Legacy UARTE_PRIORITY used !
  ...
  // Enable TX DMA
#if defined UARTE_USE_TX && defined UARTE_USE_TX_DMA
  rcc_init_dma(UARTE_DMA);

#if defined STM32F1 || defined STM32F7
  LL_USART_EnableDMAReq_TX(UARTE_UARTx);
#endif
#endif
...
#endif
#endif
#if defined STM32G4 && !defined UARTE_USE_RXERRORCOUNT
#if !defined UARTE_USE_RXERRORCOUNT
