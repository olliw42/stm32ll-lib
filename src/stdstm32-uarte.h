...
#elif defined STM32F3
  #warning UARTE F3 check clear flags, should be LL !?
  // ORE is enabled along with RXNE, but can be cleared by writing 1 to ICR
  LL_USART_WriteReg(UARTE_UARTx, ICR, (USART_ICR_ORECF | USART_ICR_NCF | USART_ICR_FECF | USART_ICR_PECF | USART_ICR_IDLECF));
#elif defined STM32F7
...
#if !(defined UARTE_USE_LPUART1 || defined UARTE_USE_LPUART1_REMAPPED) // for the moment, don't allow it for LPUART
