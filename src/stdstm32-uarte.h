...
// #define UARTE_USE_LPUART1, UARTE_USE_LPUART1_REMAPPED
// 
// #define UARTE_BAUD
//
// #define UARTE_USE_TX
...
#elif defined UARTE_USE_UART3 || defined UARTE_USE_UART3_REMAPPED
...
#elif defined UARTE_USE_LPUART1 || defined UARTE_USE_LPUART1_REMAPPED
  #define UARTE_UARTx             LPUART1
  #ifdef UARTE_USE_LPUART1
    #define UARTE_TX_IO           IO_PA2
    #define UARTE_RX_IO           IO_PA3
    #define UARTE_IO_AF           IO_AF_12
  #elif defined UARTE_USE_LPUART1_REMAPPED
...
void UARTE_IRQHandler(void)
{
  ...
  LL_USART_WriteReg(UARTE_UARTx, ICR, (LL_USART_ICR_IDLECF | LL_USART_ICR_ORECF | LL_USART_ICR_NCF | LL_USART_ICR_FECF | LL_USART_ICR_PECF));
#elif defined STM32F7
  ...
  LL_USART_WriteReg(UARTE_UARTx, ICR, (LL_USART_ICR_IDLECF | LL_USART_ICR_ORECF | LL_USART_ICR_NECF | LL_USART_ICR_FECF | LL_USART_ICR_PECF));
#endif
#endif
...
#if !(defined UARTE_USE_LPUART1 || defined UARTE_USE_LPUART1_REMAPPED) || defined STM32WL
...
LL_LPUART_InitTypeDef LPUART_InitStruct = {0};
  LPUART_InitStruct.BaudRate = UARTE_BAUD;
  ...
  LL_LPUART_Init(UARTE_UARTx, &LPUART_InitStruct);
