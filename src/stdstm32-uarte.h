...
// Interface:
//
// #define UARTE_USE_UART1, UARTE_USE_UART1_PA9PA10, UARTE_USE_UART1_PB6PB7, UARTE_USE_UART1_PC4PC5, UARTE_USE_UART1_PB14PB15
// #define UARTE_USE_UART2, UARTE_USE_UART2_PA2PA3, UARTE_USE_UART2_PD5PD6, UARTE_USE_UART2_PB3PB4, UARTE_USE_UART2_PA14PA15, UARTE_USE_UART2_PA5PA15
// #define UARTE_USE_UART3, UARTE_USE_UART3_PB10PB11, UARTE_USE_UART3_PC10PC11, UARTE_USE_UART3_PB8PB9, UARTE_USE_UART3_PA4PA3, UARTE_USE_UART3_PB3PB8
// #define UARTE_USE_UART4, UARTE_USE_UART4_PC10PC11, UARTE_USE_UART4_PA0PA1
// #define UARTE_USE_UART5, UARTE_USE_UART5_PC12PD2
// #define UARTE_USE_UART6, UARTE_USE_UART6_PC6PC7, UARTE_USE_UART6_PG14PG9
// #define UARTE_USE_UART7, UARTE_USE_UART7_PE8PE7, UARTE_USE_UART7_PF7PF6, UARTE_USE_UART7_PB4PB3, UARTE_USE_UART7_PA15PA8
// #define UARTE_USE_UART8, UARTE_USE_UART8_PE1PE0
// #define UARTE_USE_LPUART1, UARTE_USE_LPUART1_PA2PA3, UARTE_USE_LPUART1_PC1PC0, UARTE_USE_LPUART1_PA9PA10, UARTE_USE_LPUART1_PB6PB7
//
// #define UARTE_BAUD
//
// #define UARTE_USE_TX
...
// see stdstm32-peripherals.h
      ...
      defined UARTE_USE_UART1_PB14PB15
  ...
  #elif defined UARTE_USE_UART1_PB14PB15 // only H5
    #define UARTE_TX_IO           IO_PB14
    #define UARTE_RX_IO           IO_PB15
  #endif
  #ifndef STM32F0
  ...
  #define UARTE_IRQHandler        USART1_IRQHandler
    ...
    #if defined UARTE_USE_UART1_PB14PB15
      #undef UARTE_IO_AF
      #define UARTE_IO_AF         IO_AF_4
    #elif defined UARTE_USE_UART1_PC4PC5
      #error UARTE_USE_UART1_PC4PC5 not available on STM32H5 !
    #endif
  #endif

#elif defined UARTE_USE_UART2 || defined UARTE_USE_UART2_PA2PA3 || defined UARTE_USE_UART2_PD5PD6 || \
      defined UARTE_USE_UART2_PB3PB4 || defined UARTE_USE_UART2_PA14PA15 || defined UARTE_USE_UART2_PB3PA15 || \
      defined UARTE_USE_UART2_PA5PA15
  ...
  #elif defined UARTE_USE_UART2_PB3PA15 // only G4
    #define UARTE_TX_IO           IO_PB3
    #define UARTE_RX_IO           IO_PA15
  #elif defined UARTE_USE_UART2_PA5PA15 // only H5, the AN2606 bootloader pair
    #define UARTE_TX_IO           IO_PA5
    #define UARTE_RX_IO           IO_PA15
  #endif
  #ifndef STM32F0
    #define UARTE_IO_AF           IO_AF_7
  ...
  #define UARTE_IRQHandler        USART2_IRQHandler
    ...
    // H5: PA2/PA3 is AF7 as set above on both lines, everything else differs
      ...
      // H56x has USART2 only on PA2/PA3 and PD5/PD6, and PD5/PD6 is not bonded
        ...
        #error UARTE_USE_UART2_PD5PD6 not bonded on STM32H56x packages up to LQFP64 ! use UARTE_USE_UART2_PA2PA3
      #elif defined UARTE_USE_UART2_PA5PA15 || defined UARTE_USE_UART2_PB3PB4 || \
            defined UARTE_USE_UART2_PA14PA15 || defined UARTE_USE_UART2_PB3PA15
        #error UARTE_USE_UART2 mapping not available on STM32H56x ! use UARTE_USE_UART2_PA2PA3
      #endif
    #else
      // H503, the other mappings use different AFs
      #if defined UARTE_USE_UART2_PB3PB4
        #undef UARTE_IO_AF
        #define UARTE_IO_AF       IO_AF_13
      #elif defined UARTE_USE_UART2_PA14PA15
        #undef UARTE_IO_AF
        #define UARTE_IO_AF       IO_AF_9 // ATTENTION: PA14 overlaps with SWCLK
      #elif defined UARTE_USE_UART2_PA5PA15
        #undef UARTE_IO_AF
        #define UARTE_IO_AF       IO_AF_9
      #elif defined UARTE_USE_UART2_PD5PD6
        #error UARTE_USE_UART2_PD5PD6 not available on STM32H503 !
      #elif defined UARTE_USE_UART2_PB3PA15
        #error UARTE_USE_UART2_PB3PA15 not available on STM32H503 !
      #endif
    #endif
  #endif
      ...
      defined UARTE_USE_UART3_PA4PA3 || defined UARTE_USE_UART3_PB3PB8
  ...
  #elif defined UARTE_USE_UART3_PA4PA3 // only H5
    #define UARTE_TX_IO           IO_PA4
    #define UARTE_RX_IO           IO_PA3
  #elif defined UARTE_USE_UART3_PB3PB8 // only H5
    #define UARTE_TX_IO           IO_PB3
    #define UARTE_RX_IO           IO_PB8
  #else
  #endif
  #ifndef STM32F0
    #define UARTE_IO_AF           IO_AF_7
  ...
  #define UARTE_IRQHandler        USART3_IRQHandler
    ...
    #define UARTE_IRQHandler      USART3_4_IRQHandler
      ...
      #if defined UARTE_USE_UART3_PB10PB11
        #error UARTE_USE_UART3_PB10PB11 not bonded on STM32H56x packages up to LQFP64, PB11 is missing ! use UARTE_USE_UART3_PC10PC11
      #elif defined UARTE_USE_UART3_PB8PB9
        #error UARTE_USE_UART3_PB8PB9 not bonded on STM32H56x packages up to LQFP64, PB9 is missing ! use UARTE_USE_UART3_PC10PC11
      #elif defined UARTE_USE_UART3_PA4PA3 || defined UARTE_USE_UART3_PB3PB8
        #error UARTE_USE_UART3 mapping not available on STM32H56x ! use UARTE_USE_UART3_PC10PC11
      #endif
    #else
      ...
      #if defined UARTE_USE_UART3_PA4PA3 || defined UARTE_USE_UART3_PB3PB8
        #undef UARTE_IO_AF
        #define UARTE_IO_AF       IO_AF_13
      #elif defined UARTE_USE_UART3_PB10PB11
        #error UARTE_USE_UART3_PB10PB11 not available on STM32H503, PB11 does not exist ! use UARTE_USE_UART3_PA4PA3 or UARTE_USE_UART3_PB3PB8
      #elif defined UARTE_USE_UART3_PB8PB9
        #error UARTE_USE_UART3_PB8PB9 not available on STM32H503, PB9 does not exist ! use UARTE_USE_UART3_PB3PB8
      #elif defined UARTE_USE_UART3_PC10PC11
        #error UARTE_USE_UART3_PC10PC11 not available on STM32H503 LQFP48, port C is not bonded !
      #endif
    #endif
  #endif
  ...
  #define UARTE_UARTx             UART4
    ...
    #define UARTE_TX_IO           IO_PC10
    #define UARTE_RX_IO           IO_PC11
  #elif defined UARTE_USE_UART4_PA0PA1 // only F7, H56x // was UART4_REMAPPED
...
#elif defined UARTE_USE_UART6 || defined UARTE_USE_UART6_PC6PC7 || defined UARTE_USE_UART6_PG14PG9
  ...
  #define UARTE_IRQHandler        USART6_IRQHandler
    ...
    // H56x USART6 is AF7, not AF8, and only PC6/PC7 is bonded up to LQFP64
    ...
    #elif defined UARTE_USE_UART6_PG14PG9
      #error UARTE_USE_UART6_PG14PG9 not bonded on STM32H56x packages up to LQFP64 ! use UARTE_USE_UART6_PC6PC7
    #else
      #undef UARTE_IO_AF
      #define UARTE_IO_AF         IO_AF_7
    #endif
      ...
      defined UARTE_USE_UART7_PB4PB3 || defined UARTE_USE_UART7_PA15PA8
  ...
  #elif defined UARTE_USE_UART7_PB4PB3 // only H56x
    #define UARTE_TX_IO           IO_PB4
    #define UARTE_RX_IO           IO_PB3
  #elif defined UARTE_USE_UART7_PA15PA8 // only H56x // ATTENTION: PA15 is JTDI
    #define UARTE_TX_IO           IO_PA15
    #define UARTE_RX_IO           IO_PA8
  #endif
  #define UARTE_IO_AF             IO_AF_8
  ...
  #define UARTE_IRQHandler        UART7_IRQHandler
    ...
    #elif defined UARTE_USE_UART7_PE8PE7 || defined UARTE_USE_UART7_PF7PF6
      #error UARTE_USE_UART7 mapping not bonded on STM32H56x packages up to LQFP64 ! use UARTE_USE_UART7_PB4PB3 or UARTE_USE_UART7_PA15PA8
    #else
      #undef UARTE_IO_AF
      #define UARTE_IO_AF         IO_AF_11
    #endif
  #endif
  ...
  #define UARTE_IRQHandler        UART8_IRQHandler
    ...
    // H56x has UART8, but none of its pins is bonded up to LQFP64
      ...
      defined UARTE_USE_LPUART1_PA9PA10 || defined UARTE_USE_LPUART1_PB6PB7
  #define UARTE_UARTx             LPUART1
    ...
    #define UARTE_RX_IO           IO_PA3
      ...
      #undef UARTE_TX_IO
      #undef UARTE_RX_IO
      #define UARTE_TX_IO         IO_PA3
      #define UARTE_RX_IO         IO_PA2
      #define UARTE_IO_AF         IO_AF_3
    #else
    ...
    #define UARTE_IO_AF           IO_AF_8
  #elif defined UARTE_USE_LPUART1_PA9PA10 // only H5, not swapped
    #define UARTE_TX_IO           IO_PA9
    #define UARTE_RX_IO           IO_PA10
    #define UARTE_IO_AF           IO_AF_3
  #elif defined UARTE_USE_LPUART1_PB6PB7 // only H5, not swapped
    #define UARTE_TX_IO           IO_PB6
    #define UARTE_RX_IO           IO_PB7
    #define UARTE_IO_AF           IO_AF_8
  #endif
  #if defined UARTE_USE_LPUART1_PA2PA3 && defined STM32H5_H56x
    // no pins were assigned above
    #error UARTE_USE_LPUART1_PA2PA3 not available on STM32H56x ! use UARTE_USE_LPUART1_PA9PA10 or UARTE_USE_LPUART1_PB6PB7
  #endif
  ...
  #elif defined STM32WL
  #elif defined STM32H5
    #if defined UARTE_USE_LPUART1_PC1PC0
      #if defined STM32H5_H56x
        // PC0/PC1 are bonded on LQFP64, but carry SAI2, not LPUART1
        #error UARTE_USE_LPUART1_PC1PC0 not available on STM32H56x, PC0/PC1 are not LPUART1 pins ! use UARTE_USE_LPUART1_PA9PA10 or UARTE_USE_LPUART1_PB6PB7
      #else
        #error UARTE_USE_LPUART1_PC1PC0 not available on STM32H503 LQFP48, port C is not bonded !
      #endif
    #endif
  #endif
...
#if defined UARTE_USE_TX && !defined UARTE_TX_IO
  #error No UARTE TX IO defined!
#endif
#if defined UARTE_USE_RX && !defined UARTE_RX_IO
...
// AN2606 Application note: STM32 microcontroller system memory boot mode
  ...
  #if defined UARTE_USE_UART1_PA9PA10 || defined UARTE_USE_UART2_PA5PA15 || defined UARTE_USE_UART3_PA4PA3
    #define UARTE_HAS_SYSTEMBOOT
  #endif
