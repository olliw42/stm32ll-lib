...
#include "stdstm32-peripherals.h"
  ...
  #elif defined UARTB_USE_UART2_REMAPPED3 // only G4 // ATTENTION: PA14 overlaps with SWCLK
...
#elif defined STM32F3
  #warning UARTB F3 check clear flags, should be LL !?
  // ORE is enabled along with RXNE, but can be cleared by writing 1 to ICR
  LL_USART_WriteReg(UARTB_UARTx, ICR, (USART_ICR_ORECF | USART_ICR_NCF | USART_ICR_FECF | USART_ICR_PECF | USART_ICR_IDLECF));
#elif defined STM32F7
...
#elif defined STM32L4
  #warning UARTB L4 check clear flags, should be LL !?
  LL_USART_WriteReg(UARTB_UARTx, ICR, (USART_ICR_IDLECF | USART_ICR_ORECF | USART_ICR_NECF | USART_ICR_FECF | USART_ICR_PECF));
#endif
#endif
...
#if !(defined UARTB_USE_LPUART1 || defined UARTB_USE_LPUART1_REMAPPED) // for the moment, don't allow it for LPUART
...
LL_LPUART_InitTypeDef LPUART_InitStruct = {0};
  LPUART_InitStruct.BaudRate = UARTB_BAUD;
  ...
  LL_LPUART_Init(UARTB_UARTx, &LPUART_InitStruct);
