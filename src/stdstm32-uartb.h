...
// Interface:
//
// #define UARTB_USE_UART1, UARTB_USE_UART1_PA9PA10, UARTB_USE_UART1_PB6PB7, UARTB_USE_UART1_PC4PC5, UARTB_USE_UART1_PB14PB15
// #define UARTB_USE_UART2, UARTB_USE_UART2_PA2PA3, UARTB_USE_UART2_PD5PD6, UARTB_USE_UART2_PB3PB4, UARTB_USE_UART2_PA14PA15, UARTB_USE_UART2_PA5PA15
// #define UARTB_USE_UART3, UARTB_USE_UART3_PB10PB11, UARTB_USE_UART3_PC10PC11, UARTB_USE_UART3_PB8PB9, UARTB_USE_UART3_PA4PA3, UARTB_USE_UART3_PB3PB8
// #define UARTB_USE_UART4, UARTB_USE_UART4_PC10PC11, UARTB_USE_UART4_PA0PA1
// #define UARTB_USE_UART5, UARTB_USE_UART5_PC12PD2
// #define UARTB_USE_UART6, UARTB_USE_UART6_PC6PC7, UARTB_USE_UART6_PG14PG9
// #define UARTB_USE_UART7, UARTB_USE_UART7_PE8PE7, UARTB_USE_UART7_PF7PF6, UARTB_USE_UART7_PB4PB3, UARTB_USE_UART7_PA15PA8
// #define UARTB_USE_UART8, UARTB_USE_UART8_PE1PE0
// #define UARTB_USE_LPUART1, UARTB_USE_LPUART1_PA2PA3, UARTB_USE_LPUART1_PC1PC0, UARTB_USE_LPUART1_PA9PA10, UARTB_USE_LPUART1_PB6PB7
//
// #define UARTB_BAUD
//
// #define UARTB_USE_TX
...
// see stdstm32-peripherals.h
      ...
      defined UARTB_USE_UART1_PB14PB15
  ...
  #elif defined UARTB_USE_UART1_PB14PB15 // only H5
    #define UARTB_TX_IO           IO_PB14
    #define UARTB_RX_IO           IO_PB15
  #endif
  #ifndef STM32F0
  ...
  #define UARTB_IRQHandler        USART1_IRQHandler
    ...
    // H5: PA9/PA10 and PB6/PB7 are AF7 as set above, PB14/PB15 are AF4, on both lines
    #if defined UARTB_USE_UART1_PB14PB15
      #undef UARTB_IO_AF
      #define UARTB_IO_AF         IO_AF_4
    #elif defined UARTB_USE_UART1_PC4PC5
      #error UARTB_USE_UART1_PC4PC5 not available on STM32H5 !
    #endif
  #endif
      ...
      defined UARTB_USE_UART2_PA5PA15
  #define UARTB_UARTx             USART2
    ...
    #define UARTB_TX_IO           IO_PB3
    #define UARTB_RX_IO           IO_PA15
  #elif defined UARTB_USE_UART2_PA5PA15 // only H5, the AN2606 bootloader pair
    #define UARTB_TX_IO           IO_PA5
    #define UARTB_RX_IO           IO_PA15
  #endif
  #ifndef STM32F0
    #define UARTB_IO_AF           IO_AF_7
  ...
  #define UARTB_IRQHandler        USART2_IRQHandler
    ...
    // H5: PA2/PA3 is AF7 as set above on both lines, everything else differs
      ...
      // H56x has USART2 only on PA2/PA3 and PD5/PD6, and PD5/PD6 is not bonded
        ...
        #error UARTB_USE_UART2_PD5PD6 not bonded on STM32H56x packages up to LQFP64 ! use UARTB_USE_UART2_PA2PA3
      #elif defined UARTB_USE_UART2_PA5PA15 || defined UARTB_USE_UART2_PB3PB4 || \
            defined UARTB_USE_UART2_PA14PA15 || defined UARTB_USE_UART2_PB3PA15
        #error UARTB_USE_UART2 mapping not available on STM32H56x ! use UARTB_USE_UART2_PA2PA3
      #endif
    #else
      // H503, the other mappings use different AFs
      #if defined UARTB_USE_UART2_PB3PB4
        #undef UARTB_IO_AF
        #define UARTB_IO_AF       IO_AF_13
      #elif defined UARTB_USE_UART2_PA14PA15
        #undef UARTB_IO_AF
        #define UARTB_IO_AF       IO_AF_9 // ATTENTION: PA14 overlaps with SWCLK
      #elif defined UARTB_USE_UART2_PA5PA15
        #undef UARTB_IO_AF
        #define UARTB_IO_AF       IO_AF_9
      #elif defined UARTB_USE_UART2_PD5PD6
        #error UARTB_USE_UART2_PD5PD6 not available on STM32H503 !
      #elif defined UARTB_USE_UART2_PB3PA15
        #error UARTB_USE_UART2_PB3PA15 not available on STM32H503 !
      #endif
    #endif
  #endif
      ...
      defined UARTB_USE_UART3_PA4PA3 || defined UARTB_USE_UART3_PB3PB8
  ...
  #elif defined UARTB_USE_UART3_PA4PA3 // only H5
    #define UARTB_TX_IO           IO_PA4
    #define UARTB_RX_IO           IO_PA3
  #elif defined UARTB_USE_UART3_PB3PB8 // only H5
    #define UARTB_TX_IO           IO_PB3
    #define UARTB_RX_IO           IO_PB8
  #else
  #endif
  #ifndef STM32F0
    #define UARTB_IO_AF           IO_AF_7
  ...
  #define UARTB_IRQHandler        USART3_IRQHandler
    ...
    #define UARTB_IRQHandler      USART3_4_IRQHandler
      ...
      #if defined UARTB_USE_UART3_PB10PB11
        #error UARTB_USE_UART3_PB10PB11 not bonded on STM32H56x packages up to LQFP64, PB11 is missing ! use UARTB_USE_UART3_PC10PC11
      #elif defined UARTB_USE_UART3_PB8PB9
        #error UARTB_USE_UART3_PB8PB9 not bonded on STM32H56x packages up to LQFP64, PB9 is missing ! use UARTB_USE_UART3_PC10PC11
      #elif defined UARTB_USE_UART3_PA4PA3 || defined UARTB_USE_UART3_PB3PB8
        #error UARTB_USE_UART3 mapping not available on STM32H56x ! use UARTB_USE_UART3_PC10PC11
      #endif
    #else
      ...
      #if defined UARTB_USE_UART3_PA4PA3 || defined UARTB_USE_UART3_PB3PB8
        #undef UARTB_IO_AF
        #define UARTB_IO_AF       IO_AF_13
      #elif defined UARTB_USE_UART3_PB10PB11
        #error UARTB_USE_UART3_PB10PB11 not available on STM32H503, PB11 does not exist ! use UARTB_USE_UART3_PA4PA3 or UARTB_USE_UART3_PB3PB8
      #elif defined UARTB_USE_UART3_PB8PB9
        #error UARTB_USE_UART3_PB8PB9 not available on STM32H503, PB9 does not exist ! use UARTB_USE_UART3_PB3PB8
      #elif defined UARTB_USE_UART3_PC10PC11
        #error UARTB_USE_UART3_PC10PC11 not available on STM32H503 LQFP48, port C is not bonded !
      #endif
    #endif
  #endif
  ...
  #define UARTB_UARTx             UART4
    ...
    #define UARTB_TX_IO           IO_PC10
    #define UARTB_RX_IO           IO_PC11
  #elif defined UARTB_USE_UART4_PA0PA1 // only F7, H56x // was UART4_REMAPPED
...
#elif defined UARTB_USE_UART6 || defined UARTB_USE_UART6_PC6PC7 || defined UARTB_USE_UART6_PG14PG9
  ...
  #define UARTB_IRQHandler        USART6_IRQHandler
    ...
    // H56x USART6 is AF7, not AF8, and only PC6/PC7 is bonded up to LQFP64
    ...
    #elif defined UARTB_USE_UART6_PG14PG9
      #error UARTB_USE_UART6_PG14PG9 not bonded on STM32H56x packages up to LQFP64 ! use UARTB_USE_UART6_PC6PC7
    #else
      #undef UARTB_IO_AF
      #define UARTB_IO_AF         IO_AF_7
    #endif
      ...
      defined UARTB_USE_UART7_PB4PB3 || defined UARTB_USE_UART7_PA15PA8
  ...
  #elif defined UARTB_USE_UART7_PB4PB3 // only H56x
    #define UARTB_TX_IO           IO_PB4
    #define UARTB_RX_IO           IO_PB3
  #elif defined UARTB_USE_UART7_PA15PA8 // only H56x // ATTENTION: PA15 is JTDI
    #define UARTB_TX_IO           IO_PA15
    #define UARTB_RX_IO           IO_PA8
  #endif
  #define UARTB_IO_AF             IO_AF_8
  ...
  #define UARTB_IRQHandler        UART7_IRQHandler
    ...
    #elif defined UARTB_USE_UART7_PE8PE7 || defined UARTB_USE_UART7_PF7PF6
      #error UARTB_USE_UART7 mapping not bonded on STM32H56x packages up to LQFP64 ! use UARTB_USE_UART7_PB4PB3 or UARTB_USE_UART7_PA15PA8
    #else
      #undef UARTB_IO_AF
      #define UARTB_IO_AF         IO_AF_11
    #endif
  #endif
  ...
  #define UARTB_IRQHandler        UART8_IRQHandler
    ...
    // H56x has UART8, but none of its pins is bonded up to LQFP64
      ...
      defined UARTB_USE_LPUART1_PA9PA10 || defined UARTB_USE_LPUART1_PB6PB7
  #define UARTB_UARTx             LPUART1
    ...
    #define UARTB_RX_IO           IO_PA3
      ...
      #undef UARTB_TX_IO
      #undef UARTB_RX_IO
      #define UARTB_TX_IO         IO_PA3
      #define UARTB_RX_IO         IO_PA2
      #define UARTB_IO_AF         IO_AF_3
    #else
    ...
    #define UARTB_IO_AF           IO_AF_8
  #elif defined UARTB_USE_LPUART1_PA9PA10 // only H5, not swapped
    #define UARTB_TX_IO           IO_PA9
    #define UARTB_RX_IO           IO_PA10
    #define UARTB_IO_AF           IO_AF_3
  #elif defined UARTB_USE_LPUART1_PB6PB7 // only H5, not swapped
    #define UARTB_TX_IO           IO_PB6
    #define UARTB_RX_IO           IO_PB7
    #define UARTB_IO_AF           IO_AF_8
  #endif
  #if defined UARTB_USE_LPUART1_PA2PA3 && defined STM32H5_H56x
    // no pins were assigned above
    #error UARTB_USE_LPUART1_PA2PA3 not available on STM32H56x ! use UARTB_USE_LPUART1_PA9PA10 or UARTB_USE_LPUART1_PB6PB7
  #endif
  ...
  #elif defined STM32WL
  #elif defined STM32H5
    #if defined UARTB_USE_LPUART1_PC1PC0
      #if defined STM32H5_H56x
        // PC0/PC1 are bonded on LQFP64, but carry SAI2, not LPUART1
        #error UARTB_USE_LPUART1_PC1PC0 not available on STM32H56x, PC0/PC1 are not LPUART1 pins ! use UARTB_USE_LPUART1_PA9PA10 or UARTB_USE_LPUART1_PB6PB7
      #else
        #error UARTB_USE_LPUART1_PC1PC0 not available on STM32H503 LQFP48, port C is not bonded !
      #endif
    #endif
  #endif
...
void uartb_getbuf(uint8_t* buf, uint16_t len)
{
uint16_t i;

  for (i = 0; i < len; i++) buf[i] = uartb_getc();
}
...
#ifdef UARTB_USE_RX
#ifndef UARTB_INVERTED
  gpio_init_af(UARTB_RX_IO, IO_MODE_INPUT_PU, UARTB_IO_AF, IO_SPEED_VERYFAST);
#else
  gpio_init_af(UARTB_RX_IO, IO_MODE_INPUT_PD, UARTB_IO_AF, IO_SPEED_VERYFAST);
#endif
#endif
...
#ifdef UARTB_INVERTED
#ifdef UARTB_USE_TX
  LL_USART_SetTXPinLevel(UARTB_UARTx, LL_USART_TXPIN_LEVEL_INVERTED);
#endif
#ifdef UARTB_USE_RX
  LL_USART_SetRXPinLevel(UARTB_UARTx, LL_USART_RXPIN_LEVEL_INVERTED);
#endif
#endif
...
// AN2606 Application note: STM32 microcontroller system memory boot mode
...
#if defined STM32F1
  // STM32F10xx
  #if defined UARTB_USE_UART1_PA9PA10
    #define UARTB_HAS_SYSTEMBOOT
  #endif
  // STM32F105xx/107x
  ...
  #if defined UARTB_USE_UART1_PA9PA10 || defined UARTB_USE_UART2_PD5PD6
    #define UARTB_HAS_SYSTEMBOOT
  #endif
  // STM32F301xx/302x4(6/8)
  // STM32F302xD(E)/303xD(E)
  // STM32F303x4(6/8)/334xx/328xx
  //#if defined UARTB_USE_UART1_PA9PA10 || defined UARTB_USE_UART2_PA2PA3
  //  #define UARTB_HAS_SYSTEMBOOT
  //#endif
  ...
  // STM32G47xxx/48xx
  // STM32G491xx/4A1x
  #if defined UARTB_USE_UART1_PA9PA10 || defined UARTB_USE_UART2_PA2PA3 || defined UARTB_USE_UART3_PC10PC11
    #define UARTB_HAS_SYSTEMBOOT
  #endif
  ...
  // STM32F070xB
  // STM32F071xx/072x
  #if defined UARTB_USE_UART1_PA9PA10 || defined UARTB_USE_UART2_PA14PA15
    #define UARTB_HAS_SYSTEMBOOT
  #endif
  // STM32F09xxx
  // TODO
  ...
  #if defined UARTB_USE_UART1_PA9PA10 || defined UARTB_USE_UART2_PA5PA15 || defined UARTB_USE_UART3_PA4PA3
    #define UARTB_HAS_SYSTEMBOOT
  #endif
...
uint8_t uartb_has_systemboot(void)
{
#ifdef UARTB_HAS_SYSTEMBOOT
    return 1;
#else
    return 0;
#endif
