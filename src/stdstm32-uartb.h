...
// Interface:
//
// #define UARTB_USE_UART1 , UARTB_USE_UART2 , UARTB_USE_UART3 , UARTB_USE_UART3REMAPPED, UARTB_USE_UART4, UARTB_USE_UART5
// #define UARTB_BAUD
//
// #define UARTB_USE_TX
...
#if defined UARTB_USE_UART1 || defined UARTB_USE_UART1_REMAPPED
...
#elif defined UARTB_USE_UART2 || defined UARTB_USE_UART2_REMAPPED || defined UARTB_USE_UART2_REMAPPED2
...
#elif defined UARTB_USE_UART3 || defined UARTB_USE_UART3_REMAPPED || defined UARTB_USE_UART3REMAPPED
...
void UARTB_IRQHandler(void)
{
  ...
  LL_USART_WriteReg(UARTB_UARTx, ICR, (LL_USART_ICR_ORECF|LL_USART_ICR_NCF|LL_USART_ICR_FECF|LL_USART_ICR_PECF|LL_USART_ICR_IDLECF));
#elif defined STM32F7
  #warning UARTB F7 check clear flags, should be LL !?
  // these are cleared by write 1 to the ICR register, not by a read of DR register!
  LL_USART_WriteReg(UARTB_UARTx, ICR, (USART_ICR_IDLECF | USART_ICR_ORECF | USART_ICR_NCF | USART_ICR_FECF | USART_ICR_PECF));
#elif defined STM32G4
  #warning UARTB G4 check clear flags, should be LL !?
  LL_USART_WriteReg(UARTB_UARTx, ICR, (USART_ICR_IDLECF | USART_ICR_ORECF | USART_ICR_NECF | USART_ICR_FECF | USART_ICR_PECF));
#endif
#endif
  ...
  if (usart_sr & FLAG_SR_TXE) {
    if (uartb_txwritepos != uartb_txreadpos) { // fifo not empty
      ...
      LL_USART_ClearFlag_TC(UARTB_UARTx); // now enable TC interrupt
...
#if defined UARTB_USE_UART3REMAPPED
...
#error Legacy UARTB_PRIORITY used !
  ...
  // Enable TX DMA
#if defined UARTB_USE_TX && defined UARTB_USE_TX_DMA
  rcc_init_dma(UARTB_DMA);

#if defined STM32F1 || defined STM32F7
  LL_USART_EnableDMAReq_TX(UARTB_UARTx);
#endif
#endif
  ...
  CLEAR_BIT(UARTB_UARTx->CR2, (USART_CR2_LINEN | USART_CR2_CLKEN));
  CLEAR_BIT(UARTB_UARTx->CR3, (USART_CR3_SCEN | USART_CR3_HDSEL | USART_CR3_IREN));
...
#endif
#endif
#if defined STM32G4 && !defined UARTB_USE_RXERRORCOUNT
#if !defined UARTB_USE_RXERRORCOUNT
